<%-- 
    Document   : affine
    Created on : 24 Mar, 2021, 10:58:22 PM
    Author     : DELL
--%>
...
<html>
    <head>
        ...
        <title>Affine Cipher | Cryptography Application</title>
    </head>
    <body><center>
            <h1>Affine Cipher</h1><hr>
        <h2>Encrypt your text!</h2>
        <form action="affineresult.jsp" method="get">
            <table>
                <tr>
